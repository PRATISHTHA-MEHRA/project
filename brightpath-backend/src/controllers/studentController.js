...
// // // Validates only Personal & Parent Details
// // const validateStudentPayload = (body, { creating = false } = {}) => {
// //     if (!body || typeof body !== "object" || Array.isArray(body)) {
// //         throw new RequestError("A student data object is required.");
// //     }

// //     const data = { ...body };

// //     // Trim all text input strings
// //     ["name", "mobile", "school", "parent", "parentMobile", "address", "dob"].forEach(field => {
// //         if (has(data, field) && typeof data[field] === "string") {
// //             data[field] = data[field].trim();
// //         }
// //     });

// //     // Required fields check on creation
// //     if (creating) {
...
// //     // Name Validation
// //     if (has(data, "name") && (!data.name || data.name.length > 120)) {
// //         throw new RequestError("Enter a valid student name (max 120 characters).");
// //     }

// //     // Mobile Validations
// //     [["mobile", "Student"], ["parentMobile", "Parent"]].forEach(([field, label]) => {
// //         if (data[field] && !/^\+?[0-9]{7,15}$/.test(data[field].replace(/[\s-]/g, ""))) {
// //             throw new RequestError(`${label} mobile must contain 7 to 15 digits.`);
// //         }
// //     });
...
// //             if (!allowedGenders.has(g)) {
// //                 throw new RequestError("Invalid gender value provided.");
// //             }
...
// //     if (has(data, "dob") && data.dob) {
// //         if (!isIsoDate(data.dob)) {
// //             throw new RequestError("Date of birth must be a valid ISO date (YYYY-MM-DD).");
// //         }
// //     }
...
// // // Maps frontend fields specifically for Personal & Parent Details
// // const mapToDatabase = async (frontendData, existingStudent = null) => {
// //     let studentCode = existingStudent?.student_code ?? null;
